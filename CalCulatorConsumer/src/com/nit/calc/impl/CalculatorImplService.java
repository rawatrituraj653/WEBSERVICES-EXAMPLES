 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://impl.calc.nit.com/", wsdlLocation = "http://localhost:8085/CalculatorWebSer/webser?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://impl.calc.nit.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/CalculatorWebSer/webser?wsdl");
    ...
    public Calc getCalculatorImplPort() {
        return super.getPort(new QName("http://impl.calc.nit.com/", "CalculatorImplPort"), Calc.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public Calc getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.calc.nit.com/", "CalculatorImplPort"), Calc.class, features);
    }
